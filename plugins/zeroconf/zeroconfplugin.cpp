...
namespace kt
{
	...
	: Plugin(parent, name,args,NAME,AUTHOR,QString::null,i18n("Finds peers running ktorrent on the local network to share torrents with"))
	{

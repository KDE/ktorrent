...
namespace kt
{
    ...
    LogViewer::LogViewer(LogFlags* flags, QWidget* parent) : Activity(i18n("Log"), QStringLiteral("utilities-log-viewer"), 100, parent), use_rich_text(true), flags(flags), suspended(false), menu(0), max_block_count(200)
    {

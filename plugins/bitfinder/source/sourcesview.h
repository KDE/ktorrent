...
#ifndef KTSOURCESVIEW_H
#define KTSOURCESVIEW_H
	...
	class SourcesView : public QWidget
		{
			Q_OBJECT
		public:
			SourcesView (QWidget* parent = 0); //add in the model later
			~SourcesView() { }

			/// Get the media tool bar
			QToolBar* sourcesToolBar() {return toolBar;}

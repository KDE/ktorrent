...
StatsPlugin::StatsPlugin(QObject* parent, const char* qt_name, const QStringList& args):
	Plugin(parent, qt_name, args, "statsplugin", "Krzysztof Kundzicz", "athantor@gmail.com", i18n("Shows transfers statistics")), pmUiSpd(0), pmUiCon(0), pmPrefsUi(0), pmUpdTmr(0)
{ 

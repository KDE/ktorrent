...
namespace kt
{
	...
	QVariant ViewModel::Item::data(int col) const
	{
		...
		case BYTES_LEFT: return bytes_left > 0 ? BytesToString(bytes_left) : QVariant();
		case DOWNLOAD_RATE:
	...
	QVariant ViewModel::headerData(int section, Qt::Orientation orientation, int role) const
	{
		...
		if(role == Qt::DisplayRole)
		{
			...
			case BYTES_LEFT: return i18nc("Bytes left to downloaded", "Left");
		...
		else if(role == Qt::ToolTipRole)
		{
			...
			case BYTES_LEFT: return i18n("How much data left to download");

...
namespace kt
{
	...
	/**
		Item in a LabelView
	*/
	class LabelViewItem : public QWidget, public Ui_LabelViewItem
	{
		Q_OBJECT
	public:
	...
	*/
	class LabelView : public QScrollArea
	{
		Q_OBJECT
	public:
		LabelView(QWidget *parent);
		virtual ~LabelView();
